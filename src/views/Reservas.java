...
public class Reservas extends JFrame {
	...
	public Reservas() {
		...
		//eventos
				...
				txtFechaS.addPropertyChangeListener(
					    new PropertyChangeListener() {
							...
							public void propertyChange(PropertyChangeEvent evt) {
								...
								if (txtFechaE.getDate() != null && txtFechaS.getDate() != null) {
									inicio = txtFechaE.getCalendar();
									fin = txtFechaS.getCalendar();
									System.out.println(fin.compareTo(inicio));
									if (fin.compareTo(inicio) < 0) {
										Error error = new Error("La fecha de finalizacion debe ser mayor "+
										...
										txtValor.setText(String.valueOf(rc.calcularValorReserva(inicio, fin)));
									}
								}	
